 ...
 *
 *		 Fewer interface functions that take payment arrays would have been simpler. This way might require less knowledge of the API from users, and it is certainly more immediately obvious what is going on.
 */
...
class securepay_xml_transaction
{
	 ...
	 * initFraudGuard
	 *
	 * Sets up FraudGuard details for FraudGuard transactions. Call this before the process* function.
	 *
